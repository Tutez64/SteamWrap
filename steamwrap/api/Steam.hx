...
class Steam {
	...
	public static function init(appId_:Int, notificationPosition:SteamNotificationPosition = SteamNotificationPosition.BottomRight) {
		...
		try {
			SteamWrap_ClearAchievement = Loader.loadRaw("SteamWrap_ClearAchievement", 1);
			SteamWrap_DownloadScores = Loader.loadRaw("SteamWrap_DownloadScores", 4);
			SteamWrap_FindLeaderboard = Loader.loadRaw("SteamWrap_FindLeaderboard", 1);
			SteamWrap_GetCurrentGameLanguage = Loader.loadRaw("SteamWrap_GetCurrentGameLanguage", 0);
			SteamWrap_GetGlobalStat = Loader.loadRaw("SteamWrap_GetGlobalStat", 1);
			SteamWrap_GetStat = Loader.loadRaw("SteamWrap_GetStat", 1);
			SteamWrap_GetStatFloat = Loader.loadRaw("SteamWrap_GetStatFloat", 1);
			SteamWrap_GetStatInt = Loader.loadRaw("SteamWrap_GetStatInt", 1);
			SteamWrap_IndicateAchievementProgress = Loader.loadRaw("SteamWrap_IndicateAchievementProgress", 3);
			SteamWrap_Init = Loader.loadRaw("SteamWrap_Init", 2);
			SteamWrap_IsSteamInBigPictureMode = Loader.loadRaw("SteamWrap_IsSteamInBigPictureMode", 0);
			SteamWrap_IsSteamRunning = Loader.loadRaw("SteamWrap_IsSteamRunning", 0);
			SteamWrap_IsSteamRunningOnSteamDeck = Loader.loadRaw("SteamWrap_IsSteamRunningOnSteamDeck", 0);
			SteamWrap_IsOverlayEnabled = Loader.loadRaw("SteamWrap_IsOverlayEnabled", 0);
			SteamWrap_BOverlayNeedsPresent = Loader.loadRaw("SteamWrap_BOverlayNeedsPresent", 0);
			SteamWrap_RequestStats = Loader.loadRaw("SteamWrap_RequestStats", 0);
			SteamWrap_RunCallbacks = Loader.loadRaw("SteamWrap_RunCallbacks", 0);
			SteamWrap_SetAchievement = Loader.loadRaw("SteamWrap_SetAchievement", 1);
			SteamWrap_GetAchievement = Loader.loadRaw("SteamWrap_GetAchievement", 1);
			SteamWrap_GetAchievementDisplayAttribute = Loader.loadRaw("SteamWrap_GetAchievementDisplayAttribute", 2);
			SteamWrap_GetNumAchievements = Loader.loadRaw("SteamWrap_GetNumAchievements", 0);
			SteamWrap_GetAchievementName = Loader.loadRaw("SteamWrap_GetAchievementName", 1);
			SteamWrap_GetSteamID = Loader.loadRaw("SteamWrap_GetSteamID", 0);
			SteamWrap_GetPersonaName = Loader.loadRaw("SteamWrap_GetPersonaName", 0);
			SteamWrap_GetFriendPersonaName = Loader.loadRaw("SteamWrap_GetFriendPersonaName", 1);
			SteamWrap_GetPersonaState = Loader.loadRaw("SteamWrap_GetPersonaState", 0);
			SteamWrap_GetFriendPersonaState = Loader.loadRaw("SteamWrap_GetFriendPersonaState", 1);
			SteamWrap_GetFriendCount = Loader.loadRaw("SteamWrap_GetFriendCount", 1);
			SteamWrap_GetFriendByIndex = Loader.loadRaw("SteamWrap_GetFriendByIndex", 2);
			SteamWrap_GetSmallFriendAvatar = Loader.loadRaw("SteamWrap_GetSmallFriendAvatar", 1);
			SteamWrap_GetMediumFriendAvatar = Loader.loadRaw("SteamWrap_GetMediumFriendAvatar", 1);
			SteamWrap_GetLargeFriendAvatar = Loader.loadRaw("SteamWrap_GetLargeFriendAvatar", 1);
			SteamWrap_StartVoiceRecording = Loader.loadRaw("SteamWrap_StartVoiceRecording", 0);
			SteamWrap_StopVoiceRecording = Loader.loadRaw("SteamWrap_StopVoiceRecording", 0);
			SteamWrap_GetAvailableVoice = Loader.loadRaw("SteamWrap_GetAvailableVoice", 0);
			SteamWrap_GetVoice = Loader.loadRaw("SteamWrap_GetVoice", 0);
			SteamWrap_DecompressVoice = Loader.loadRaw("SteamWrap_DecompressVoice", 1);
			SteamWrap_RequestUserInformation = Loader.loadRaw("SteamWrap_RequestUserInformation", 2);
			SteamWrap_GetImageSize = Loader.loadRaw("SteamWrap_GetImageSize", 1);
			SteamWrap_GetImageBytes = Loader.loadRaw("SteamWrap_GetImageBytes", 1);
			SteamWrap_SetStat = Loader.loadRaw("SteamWrap_SetStat", 2);
			SteamWrap_SetStatFloat = Loader.loadRaw("SteamWrap_SetStatFloat", 2);
			SteamWrap_SetStatInt = Loader.loadRaw("SteamWrap_SetStatInt", 2);
			SteamWrap_Shutdown = Loader.loadRaw("SteamWrap_Shutdown", 0);
			SteamWrap_StoreStats = Loader.loadRaw("SteamWrap_StoreStats", 0);
			SteamWrap_UploadScore = Loader.loadRaw("SteamWrap_UploadScore", 3);
			SteamWrap_RequestGlobalStats = Loader.loadRaw("SteamWrap_RequestGlobalStats", 0);
			SteamWrap_RestartAppIfNecessary = Loader.loadRaw("SteamWrap_RestartAppIfNecessary", 1);
			SteamWrap_OpenOverlayToURL = Loader.loadRaw("SteamWrap_OpenOverlayToURL", 1);
			SteamWrap_OpenOverlay = Loader.loadRaw("SteamWrap_OpenOverlay", 1);
			SteamWrap_ActivateGameOverlayToStore = Loader.loadRaw("SteamWrap_ActivateGameOverlayToStore", 2);
			SteamWrap_GetAuthTicketForWebApi = Loader.loadRaw("SteamWrap_GetAuthTicketForWebApi", 1);
			SteamWrap_GetAuthTicketForWebApiResultHandle = Loader.loadRaw("SteamWrap_GetAuthTicketForWebApiResultHandle", 0);
			SteamWrap_GetAuthTicketForWebApiResultHexString = Loader.loadRaw("SteamWrap_GetAuthTicketForWebApiResultHexString", 0);
			SteamWrap_CancelAuthTicket = Loader.loadRaw("SteamWrap_CancelAuthTicket", 1);
			SteamWrap_GetAppID = Loader.loadRaw("SteamWrap_GetAppID", 0);
			SteamWrap_BIsAppInstalled = Loader.loadRaw("SteamWrap_BIsAppInstalled", 1);
			SteamWrap_BIsDlcInstalled = Loader.loadRaw("SteamWrap_BIsDlcInstalled", 1);
		} catch (e:Dynamic) {
	...
	public static function openOverlayToURL(url:String) {
		if (!active)
			return;
		SteamWrap_OpenOverlayToURL(url);
	}
	 ...
	 */
	public static function openOverlay(dialog:String) {
		if (!active)
			return;
